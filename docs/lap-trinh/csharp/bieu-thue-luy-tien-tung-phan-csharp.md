...
[Tải code VS 2015](http://www.mediafire.com/download/4ms5zz3smt207rt/sln_tinhthuethunhapcanhan.rar) — các bạn muốn chạy thì tự thiết kế lại bảng lũy tiến thuế vì chỉ có vài dòng dữ liệu mẫu.
